...
render() {
    ...
    return (
        <nav className="bg-gray-800 text-white px-6 py-4 flex justify-between items-center">
            ...
            <button onClick={this.toggleProfileMenu} className="flex items-center focus:outline-none focus:shadow-outline">
            ...
            {isProfileMenuOpen && (
                ...
                <a href="/user-profile" className="block px-4 py-2 text-sm hover:bg-gray-200">Profile</a>
                <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-200">Settings</a>
                {logout && <a href="#" onClick={logout} className="block px-4 py-2 text-sm hover:bg-gray-200">Logout</a>}
                </div>
            )}
            </div>              
        </nav>
